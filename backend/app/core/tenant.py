...
async def tenant_middleware(request: Request, call_next):
    ...
    try:
        ...
        public_paths = ["/", "/health", "/api/docs", "/api/redoc", "/api/openapi.json", "/api/v1/auth/login", "/api/v1/tenants/available", "/tenants/available", "/api/v1/entrevistas/guias", "/api/v1/entrevistas/plantillas", "/api/v1/entrevistas/formatos", "/api/v1/capacitacion/modulos"]
