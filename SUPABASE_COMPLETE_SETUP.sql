-- 🚀 SCRIPT COMPLETO PARA CONFIGURAR SUPABASE DESDE CERO
-- Este script crea todas las tablas necesarias y los usuarios iniciales
-- Ejecutar en el SQL Editor de Supabase

-- 🔍 Verificar si estamos en el esquema correcto
SET search_path TO public;

-- 🗄️ CREAR TABLA DE USUARIOS
...
('Empresa Demo', 'demo', 'Empresa de demostración para pruebas del sistema LPDP')
